-- ============================================================
-- Migration: Invoice Intelligence System
-- Date: 2026-03-09
-- Description:
--   1. invoices — parsed/uploaded supplier invoices
--   2. invoice_line_items — per-line extraction results
--   3. reconciliation_logs — PO vs invoice reconciliation
--   4. reconciliation_line_items — per-line variance tracking
--   5. suppliers.invoice_email_domains — email sender matching
--   6. Supabase Storage bucket: invoices
...
-- ═══════════════════════════════════════════════════════════
-- 5. Add invoice_email_domains to suppliers (safe: additive)
-- ═══════════════════════════════════════════════════════════

ALTER TABLE suppliers
  ADD COLUMN IF NOT EXISTS invoice_email_domains text[];
...
-- ═══════════════════════════════════════════════════════════
-- 7. Storage bucket (idempotent via DO block)
-- ═══════════════════════════════════════════════════════════
...
-- Storage RLS: org-scoped read/write
-- Path format: {org_id}/{venue_id}/{filename}
...
-- ═══════════════════════════════════════════════════════════
-- 10. RLS policies — invoice_line_items (via invoices)
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- 11. RLS policies — reconciliation_logs
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- 12. RLS policies — reconciliation_line_items (via reconciliation_logs)
-- ═══════════════════════════════════════════════════════════
