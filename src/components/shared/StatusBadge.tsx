...
const STATUS_STYLES: Record<StatusVariant, string> = {
  ...
  // Roles
  manager:
    "bg-teal-50   text-teal-800   border-teal-200   dark:bg-teal-900/20 dark:text-teal-400 dark:border-teal-800",
  supervisor:
      ...
      >
        <span
          className={cn(
            ...
            DOT_COLORS[status] || "bg-slate-400",
          )}
        />
        {label}
      </span>
