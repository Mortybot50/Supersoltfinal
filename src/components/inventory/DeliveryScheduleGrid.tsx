...
export function DeliveryScheduleGrid({
  ...
  const updateEntry = (
    dayIndex: number,
    updates: Partial<DeliveryScheduleEntry>,
  ) => {
  ...
  return (
    <Card className="p-4">
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    updateEntry(idx, {
                      ...
                      order_by_time: checked
                        ? entry.order_by_time || "14:00"
                        : null,
                ...
                <>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateEntry(idx, { order_by_time: e.target.value })
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      disabled={disabled}
                      onValueChange={(v) =>
                        updateEntry(idx, { delivery_day: parseInt(v) })
                      }
                    >
      ...
      <p className="text-[10px] text-muted-foreground mt-2">
        Check days when orders can be placed. Set cut-off time and expected
