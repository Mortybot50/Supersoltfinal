...
export function OpenShiftBanner() {
  const { openShifts, staff, updateShift, deleteShift, selectedDate } =
    useRosterStore();
    ...
    <div className="bg-blue-50 border-t border-blue-200 px-3 py-2 print:hidden">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-sm font-semibold text-blue-800">
          {visibleOpenShifts.length} Open Shift
          {visibleOpenShifts.length > 1 ? "s" : ""}
        </span>
          ...
          return (
            ...
            >
              <div>
                ...
                <Badge
                  variant="outline"
                  className="ml-1 text-[9px] h-4 px-1 capitalize border-blue-200 text-blue-600"
                >
                  {shift.role}
                </Badge>
              </div>
