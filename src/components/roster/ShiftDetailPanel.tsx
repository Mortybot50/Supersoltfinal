...
export function ShiftDetailPanel() {
  ...
  const penaltyLabel =
    PENALTY_LABELS[shift.penalty_type || "none"] || "Base rate";
      ...
      >
        <div>
          <div className={cn("text-sm font-semibold", colors.text)}>
            {shift.staff_name || "Open Shift"}
          </div>
          <div className={cn("text-xs capitalize opacity-75", colors.text)}>
            {shift.role}
          </div>
        </div>
        <button
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <div className="flex-1">
              <span className="font-medium">
                {formatCurrency(shift.total_cost)}
              </span>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {format(shiftDate, "d MMM")} (
              {formatTimeCompact(shift.start_time)}–
              {formatTimeCompact(shift.end_time)}). This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
