...
export type InvoiceIntakeStatus =
  ...
  | "rejected"
  | "failed";
export type InvoiceIntakeSource =
  | "UPLOAD"
  | "EMAIL"
  | "EDI"
  | "PEPPOL"
...
export const AU_HOSPITALITY_PENALTY_RATES = {
  ...
  sunday: 1.5, // 150% of base
  public_holiday: 2.5, // 250% of base
  ...
  early_morning: 1.1, // Before 7am (10% loading)

  // Overtime rates (full-time only: beyond 38hrs/week or 10hrs/day)
  overtime_first_2_hours: 1.5, // First 2 hours of overtime
  overtime_after_2_hours: 2.0, // After 2 hours of overtime
  overtime_sunday: 2.0, // Sunday overtime
  overtime_public_holiday: 2.5, // Public holiday overtime
