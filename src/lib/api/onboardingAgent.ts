...
export class ConversationEngine {
    ...
    switch (currentStep) {
      case "welcome":
        ...
        return {
          ...
          quickActions: [
            {
              id: "square-yes",
              label: "Yes, connect Square",
              value: "connect_square",
            },
            {
              id: "square-later",
      ...
      case "square_check":
        if (
          ...
          userInput === "connect_square"
        ) {
          this.conversationState!.currentStep = "square_connecting";
          return {
            message:
              "Perfect! I'll connect to your Square account now. This lets me import your menu, staff, and recent sales data automatically.",
            quickActions: [
              {
                id: "connect",
                label: "Connect Square Account",
                value: "oauth_square",
                action: "custom",
              },
            ],
          ...
          return {
            message:
              "Square is a popular payment system used by thousands of Australian restaurants. If you use Square, I can automatically import your menu items, staff list, and sales history - saves heaps of time!",
            quickActions: [
              {
                id: "square-yes",
                label: "I have Square - connect it",
                value: "connect_square",
              },
              {
                id: "square-no",
                label: "I use something else",
                value: "skip_square",
              },
            ],
          };
  ...
  async handleSquareCallback(orgId: string, importData: any): Promise<void> {
    ...
    // Start imports
    const results = await squareImporter.importAll(
      orgId,
