...
const DEMO_INGREDIENTS = [
  // Proteins
  { name: "Beef Mince", unit: "kg", category: "Proteins", current_price: 12.50 },
  { name: "Chicken Breast", unit: "kg", category: "Proteins", current_price: 15.00 },
  { name: "Salmon Fillet", unit: "kg", category: "Proteins", current_price: 38.00 },
  { name: "Prawns", unit: "kg", category: "Proteins", current_price: 42.00 },
  
  // Produce
  { name: "Tomatoes", unit: "kg", category: "Produce", current_price: 5.50 },
  { name: "Lettuce", unit: "each", category: "Produce", current_price: 3.20 },
  { name: "Onions", unit: "kg", category: "Produce", current_price: 2.80 },
  { name: "Mushrooms", unit: "kg", category: "Produce", current_price: 12.00 },
  
  // Dairy
  { name: "Mozzarella", unit: "kg", category: "Dairy", current_price: 18.50 },
  { name: "Parmesan", unit: "kg", category: "Dairy", current_price: 32.00 },
  { name: "Cream", unit: "L", category: "Dairy", current_price: 8.50 },
  { name: "Butter", unit: "kg", category: "Dairy", current_price: 16.00 },
  
  // Dry Goods
  { name: "Pasta", unit: "kg", category: "Dry Goods", current_price: 4.50 },
  { name: "Rice", unit: "kg", category: "Dry Goods", current_price: 3.80 },
  { name: "Flour", unit: "kg", category: "Dry Goods", current_price: 2.20 },
  { name: "Olive Oil", unit: "L", category: "Dry Goods", current_price: 18.00 }
]

const DEMO_MENU_ITEMS = [
  { name: "Margherita Pizza", category: "Pizza", price: 22.00 },
  { name: "Pepperoni Pizza", category: "Pizza", price: 26.00 },
  { name: "Spaghetti Bolognese", category: "Pasta", price: 24.00 },
  { name: "Fettuccine Carbonara", category: "Pasta", price: 26.00 },
  { name: "Grilled Salmon", category: "Mains", price: 38.00 },
  { name: "Chicken Parmigiana", category: "Mains", price: 32.00 },
  { name: "Caesar Salad", category: "Salads", price: 18.00 },
  { name: "Greek Salad", category: "Salads", price: 16.00 },
  { name: "Tiramisu", category: "Desserts", price: 14.00 },
  { name: "Panna Cotta", category: "Desserts", price: 12.00 }
]

export async function seedDemoData(supabase: Client, userId: string): Promise<SeedResult> {
  try {
    ...
    for (let i = 0; i < 30; i++) {
      ...
      // Insert sales in batches to improve performance
