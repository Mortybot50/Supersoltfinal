...
const PurchaseOrderDetail = lazy(
  () => import("./pages/inventory/PurchaseOrderDetail"),
);
...
const InventoryReports = lazy(
  () => import("./pages/inventory/InventoryReports"),
);
const FoodCostAnalysis = lazy(
  () => import("./pages/inventory/FoodCostAnalysis"),
);
const PriceTracking = lazy(() => import("./pages/inventory/PriceTracking"));
const POReceiving = lazy(() => import("./pages/inventory/POReceiving"));
const PurchaseByInvoice = lazy(
  () => import("./pages/inventory/PurchaseByInvoice"),
);
const PurchaseFromInvoice = lazy(
  () => import("./pages/inventory/PurchaseFromInvoice"),
);
...
const InventoryInsights = lazy(
  () => import("./pages/insights/InventoryInsights"),
);
...
const AvailabilityLeave = lazy(
  () => import("./pages/labour/AvailabilityLeave"),
);
...
const XeroAccountMappings = lazy(
  () => import("./pages/admin/XeroAccountMappings"),
);
...
// Dev Tools
const DevTools = lazy(() => import("./pages/dev"));
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  >
                    ...
                    />
                    <Route
                      path="inventory/invoices/:invoiceId/reconcile"
                      element={<Reconciliation />}
                    />
                    <Route
                      path="inventory/purchase-by-invoice"
                      element={<PurchaseByInvoice />}
                    />
                    <Route
                      path="inventory/purchases/from-invoice/:invoiceId"
                      element={<PurchaseFromInvoice />}
                    />
                    <Route
                      path="inventory/food-cost"
                      element={<FoodCostAnalysis />}
                    />
                    <Route
                      path="inventory/price-tracking"
                      element={<PriceTracking />}
                    />
                    <Route
                      path="inventory/pos-mapping"
                      element={<POSMapping />}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="workforce/timesheets/daily/:date"
                      element={<TimesheetsDaily />}
                    />
                    <Route
                      path="workforce/timesheets/:staffId/:periodStart"
                      element={<TimesheetDetail />}
                    />
                    <Route
                      path="workforce/reports"
                      element={<LabourReports />}
                    />
                    <Route
                      path="labour-reports"
                      element={<Navigate to="/workforce/reports" replace />}
                    />
                    <Route path="workforce/people" element={<People />} />
                    <Route
                      path="workforce/people/:id"
                      element={<StaffDetail />}
                    />
                    <Route
                    ...
                    <Route
                      ...
                      element={<AvailabilityLeave />}
                    />
                    <Route
                      path="labour/availability"
                      element={
                        <Navigate to="/workforce/availability" replace />
                      }
                    />
                    <Route
                      path="workforce/payroll-export"
                    ...
                    />
                    <Route
                      path="admin/venue-settings"
                      element={<VenueSettings />}
                    />
                    ...
                    />
                    <Route
                      path="admin/integrations/xero/mappings"
                      element={
                        <ProtectedRoute requiredRole="admin">
                          <XeroAccountMappings />
                        </ProtectedRoute>
                    ...
                    <Route
                      ...
                      element={<Navigate to="/inventory/ingredients" replace />}
                    />
                    <Route
                      path="settings"
                      element={<Navigate to="/admin/org-settings" replace />}
                    />
                    <Route
                      path="integrations"
                  ...
                  {/* Setup Wizard - Outside Layout to avoid showing sidebar */}
                  <Route
                    path="/setup"
                    element={
                      <ProtectedRoute>
                  ...
                  />
                  <Route
                    path="onboarding/portal/:token/step:stepNumber"
                    element={<InviteStep />}
                  />
                </Routes>
              </Suspense>
