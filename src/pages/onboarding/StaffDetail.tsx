  ...
  const renderEditableStep = (stepNumber: number) => {
    const commonProps = {
      ...
      onComplete: (data: Record<string, unknown>) =>
        handleStepComplete(stepNumber, data),
    ...
    switch (stepNumber) {
      ...
      case 6:
        return (
          <DocumentsStep
            {...commonProps}
            onComplete={() => handleStepComplete(stepNumber, {})}
          />
        );
      case 7:
        return (
    ...
    <div className="p-4 md:p-6 space-y-6">
              ...
              variant={
                member.onboarding_status === "roster_ready"
                  ...
                  : member.onboarding_status === "pending_review"
                    ? "secondary"
                    : member.onboarding_status === "in_progress" ||
      ...
      <Tabs defaultValue="onboarding">
        ...
        <TabsContent value="onboarding">
          {editingStep ? (
            <div className="space-y-4">{renderEditableStep(editingStep)}</div>
          ) : (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="font-medium">
                  ${(member.hourly_rate / 100).toFixed(2)}
                </div>
              </div>
              <div>
                <div className="text-sm text-muted-foreground">
                ...
                <div className="font-medium">
                  {member.award_classification || "Not set"}
                </div>
              </div>
            </div>
          </Card>
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <span className="font-medium">
                    {new Date(latestInvite.sent_at).toLocaleString()}
                  </span>
                </div>
                <div>
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    {new Date(latestInvite.expires_at).toLocaleString()}
                  </span>
                </div>
                {latestInvite.accessed_at && (
                  <div>
                    ...
                    <span className="font-medium">
                      {new Date(latestInvite.accessed_at).toLocaleString()}
                    </span>
                  </div>
                )}
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 border rounded">
                ...
                >
                  {documents.some(
                    (d) =>
                      d.document_type === "id_proof" && d.status === "approved",
                  )
                    ? "Verified"
                    : "Pending"}
                </Badge>
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                ...
                <Badge
                  variant={
                    member.tfn_number || member.tfn_exemption
                      ? "default"
                      : "secondary"
                  }
                >
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                ...
                <Badge
                  variant={
                    member.super_fund_name || member.super_use_employer_default
                      ? "default"
                      : "secondary"
                  }
                >
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                ...
                <Badge
                  variant={
                    member.bank_bsb && member.bank_account_number
                      ? "default"
                      : "secondary"
                  }
                >
