...
export default function InvitePortal() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-muted/30 p-6">
        <Card className="p-8 max-w-md text-center">
          ...
          <p className="text-muted-foreground mb-6">
            This onboarding invite has expired. Please contact your manager for
            a new invite link.
          </p>
        </Card>
      </div>
  ...
  const getStepIcon = (stepNumber: number) => {
    ...
    if (stepNumber === currentStepNumber && !allComplete)
            ...
            {ONBOARDING_STEPS.map((step) => (
              <div
                ...
                className={`p-3 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors ${
                  step.number === currentStepNumber && !allComplete
        ...
        {currentStep && !allComplete && !isPendingReview && (
          <Card className="p-6 text-center">
            ...
            <Button
              size="lg"
              onClick={() =>
                navigate(`/onboarding/portal/${token}/step${currentStepNumber}`)
              }
            >
        ...
        {(allComplete || isPendingReview) && !isRosterReady && (
          <Card className="p-6 text-center bg-green-50 border-green-200">
            ...
            <p className="text-muted-foreground mb-4">
              You&apos;ve completed all onboarding steps. Your information is
              now being reviewed by management.
            </p>
          </Card>
        )}
