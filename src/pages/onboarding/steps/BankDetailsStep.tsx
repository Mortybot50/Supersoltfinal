    ...
    if (formData.bank_bsb.length >= 6) {
      ...
      if (isValid) {
        ...
        if (bankInfo) {
          ...
          setFormData((prev) => ({
            ...prev,
            bank_institution_name: bankInfo.bank,
          }));
        }
      }
    } else {
  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-muted-foreground mb-6">
        Your salary will be paid into this account. All information is securely
        encrypted.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Alert>
          <AlertDescription>
            <strong>Security Note:</strong> Your bank details are encrypted and
            stored securely. They will only be used for salary payments.
          </AlertDescription>
        </Alert>
