...
export default function TFNDeclarationStep({
  staffId,
  initialData,
  onComplete,
  onBack,
}: TFNDeclarationStepProps) {
  const [submitting, setSubmitting] = useState(false);
  const [declarationStatus, setDeclarationStatus] = useState(
    initialData?.tfn_declaration_status || "provided",
  );
  const [formData, setFormData] = useState({
    ...
    tfn_claimed_tax_free_threshold:
      initialData?.tfn_claimed_tax_free_threshold || false,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success("TFN declaration saved", {
  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-muted-foreground mb-6">
        This form complies with Australian Tax Office requirements. Your TFN is
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Alert>
          ...
          <AlertDescription>
            Providing your TFN is not compulsory. However, if you don't provide
            it, tax will be withheld at the highest rate.
          </AlertDescription>
        </Alert>
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) => {
                setFormData({
                  ...formData,
                  tfn_exemption_reason: e.target.value,
                });
                setErrors((prev) => ({ ...prev, tfn_exemption_reason: "" }));
              }}
              className={
                errors.tfn_exemption_reason ? "border-destructive" : ""
              }
            />
            {errors.tfn_exemption_reason && (
              <p className="text-sm text-destructive mt-1">
                {errors.tfn_exemption_reason}
              </p>
            )}
              ...
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({
                      ...formData,
                      tfn_claimed_tax_free_threshold: checked as boolean,
                    })
                  }
                />
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Only claim if this is your primary job. Reduces tax
                    withheld.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({
                        ...formData,
                        tfn_has_help_debt: checked as boolean,
                      })
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({
                        ...formData,
                        tfn_has_ssl_debt: checked as boolean,
                      })
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({
                        ...formData,
                        tfn_has_tsl_debt: checked as boolean,
                      })
                    }
                  />
        ...
        <Alert>
          <AlertDescription>
            <strong>Declaration:</strong> I declare that the information I have
