...
import { Download, Clock, FileSpreadsheet, ChevronDown, ChevronRight } from "lucide-react"
...
import { buildPayrollCSV, downloadCSV, type PayrollExportFormat } from "@/lib/services/timesheetService"
...
export default function PayrollExport() {
  ...
  const handleExport = () => {
    ...
    const csv = buildPayrollCSV(rows, exportFormat, dateRange.start, dateRange.end)
  ...
  const periodLabel = period === "this-week" || period === "last-week" || period === "this-fortnight"
                      ...
                      >
                        <TableCell className="font-medium">
                          <div className="flex items-center gap-1.5">
                            ...
                            {s.employmentType === "full-time" && s.actualHours > 38 && (
                              <Badge
                                variant="outline"
