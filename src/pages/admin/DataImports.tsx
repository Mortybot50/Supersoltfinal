...
import {
  ...
  type ParseResult as MenuItemsParseResult,
} from "@/lib/utils/menuItemsParser";
import {
  parseStaffExcel,
  downloadStaffTemplate,
  type ParseResult as StaffParseResult,
} from "@/lib/utils/staffParser";
...
export default function DataImports() {
  ...
  const [menuItemsResult, setMenuItemsResult] =
    useState<MenuItemsParseResult | null>(null);
  ...
  // Menu Items handlers
  const handleMenuItemsFileSelect = async (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const file = event.target.files?.[0];
    if (!file) return;
  ...
  // Staff handlers
  const handleStaffFileSelect = async (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const file = event.target.files?.[0];
    if (!file) return;
  ...
  const toolbar = <PageToolbar title="Data Imports" />;
              ...
              <TableBody>
                {importHistory.slice(0, 20).map((entry) => (
                  <TableRow key={entry.id}>
                    ...
                    <TableCell className="text-sm font-mono max-w-48 truncate">
                      {entry.file_name}
                    </TableCell>
          ...
          <TabsContent value="sales" className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <ol className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>
                      2. Fill in your sales data (sheet must be named "ORDERS")
                    </li>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          <div className="text-2xl font-bold">
                            $
                            {parseResult.summary.total_sales.toLocaleString(
                              "en-AU",
                              {
                      ...
                      {parseResult.summary.date_range.start && (
                        <div className="mt-4 text-sm text-muted-foreground">
                          ...
                          {" to "}
                          {parseResult.summary.date_range.end &&
                            format(
                              parseResult.summary.date_range.end,
                              "dd/MM/yyyy",
                            )}
                ...
                {parseResult.data.length > 0 && (
                  <div className="flex justify-end gap-2">
                    ...
                    >
                      ...
                      {isImporting
                        ? "Importing..."
                        : `Import ${parseResult.summary.valid_rows} Valid Order${parseResult.summary.valid_rows !== 1 ? "s" : ""}`}
                    </Button>
                  </div>
                )}
              </>
            ...
            {!selectedFile && !parseResult && (
              <Alert>
                ...
                <AlertDescription>
                  No file selected. Download the template above to get started,
                  or upload an existing Excel file with an "ORDERS" sheet.
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
          ...
          <TabsContent value="menu" className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <ol className="space-y-2 text-sm text-muted-foreground">
                    <li>1. Download the Excel template below</li>
                    <li>
                      2. Fill in your menu items (sheet must be named
                      "MENU_ITEMS")
                    </li>
                    <li>
                      3. Required columns: Item Name, Category, Price, GST,
                      Available
                    </li>
                    <li>4. Upload the completed file</li>
                    <li>5. Review the preview and click Import</li>
            ...
            <Card className="p-6">
              <div className="border-2 border-dashed rounded-lg p-12 text-center">
                ...
                <div className="flex justify-center gap-2">
                  <Button
                    onClick={() =>
                      document.getElementById("menu-items-upload")?.click()
                    }
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {menuItemsResult.errors.length > 10 && (
                        <p className="text-sm text-muted-foreground">
                          ...and {menuItemsResult.errors.length - 10} more
                          errors
                        </p>
                      )}
                    </div>
                ...
                {menuItemsResult.data.length > 0 && (
                  <div className="flex justify-end gap-2">
                    ...
                    >
                      ...
                      {isImportingMenuItems
                        ? "Importing..."
                        : `Import ${menuItemsResult.summary.valid_rows} Item${menuItemsResult.summary.valid_rows !== 1 ? "s" : ""}`}
                    </Button>
                  </div>
                )}
              </>
            ...
            {!menuItemsFile && !menuItemsResult && (
              <Alert>
                ...
                <AlertDescription>
                  No file selected. Download the template above to get started,
                  or upload an existing Excel file with a "MENU_ITEMS" sheet.
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
          ...
          <TabsContent value="staff" className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <ol className="space-y-2 text-sm text-muted-foreground">
                    <li>1. Download the Excel template below</li>
                    <li>
                      2. Fill in your staff details (sheet must be named
                      "STAFF")
                    </li>
                    <li>
                      3. Required columns: First Name, Last Name, Email, Phone,
                      Role, Hourly Rate, Start Date
                    </li>
            ...
            <Card className="p-6">
              <div className="border-2 border-dashed rounded-lg p-12 text-center">
                ...
                <div className="flex justify-center gap-2">
                  <Button
                    onClick={() =>
                      document.getElementById("staff-upload")?.click()
                    }
                ...
                {staffResult.data.length > 0 && (
                  <Card className="p-6">
                    ...
                    {staffResult.data.length > 100 && (
                      <p className="text-sm text-muted-foreground mt-4">
                        ...and {staffResult.data.length - 100} more staff
                        members
                      </p>
                    )}
                  </Card>
                ...
                {staffResult.data.length > 0 && (
                  <div className="flex justify-end gap-2">
                    ...
                    <Button
                      ...
                      disabled={
                        isImportingStaff || staffResult.errors.length > 0
                      }
                      className="gap-2"
                    >
                      <Upload className="w-4 h-4" />
                      {isImportingStaff
                        ? "Importing..."
                        : `Import ${staffResult.summary.valid_rows} Staff Member${staffResult.summary.valid_rows !== 1 ? "s" : ""}`}
                    </Button>
                  </div>
                )}
              </>
            ...
            {!staffFile && !staffResult && (
              <Alert>
                ...
                <AlertDescription>
                  No file selected. Download the template above to get started,
                  or upload an existing Excel file with a "STAFF" sheet.
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
